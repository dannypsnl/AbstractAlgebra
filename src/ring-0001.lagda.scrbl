...
@p{Trivial ring 就像前面群論提過的 trivial group，在 trivial ring 裡加法、乘法都一樣，因為作為只有一個元素的集合，能選擇的 n-元運算都只有一個。
...
@p{事實上如果 Ring @m{R} 的 @m{1 = 0}，那麼 @m{R} 只有一個元素}
...
@p{這裡雖然用了等一下才要證明的定理，但任何元素乘上 @m{0} 等於 @m{0} 應該是很直覺的想法}
