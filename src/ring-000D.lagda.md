...
postulate TODO : {R : 𝓤 ̇ } {{_ : Ring R}} → (I J : 𝓟 R) → (r : R) → is-prop (T I J r)
_+ᴵ_ : {R : 𝓤 ̇ } {{_ : Ring R}} → (I J : 𝓟 R) → 𝓟 R
_+ᴵ_ {_}{R} I J r = T I J r , TODO I J r
```

上面我暫時想不到怎麼處理，所以先假設了一個前提。下面是證明
...
proposition-8 {_}{R}{I}{J} I-is-ideal J-is-ideal = main
  ...
  main : IsIdeal (I +ᴵ J)
  main .close-+ {i1}{i2} (a1 , a2 , a1∈I , a2∈J , i=a1+a2) (b1 , b2 , b1∈I , b2∈J , j=b1+b2) =
    a1 +ᴿ b1 , a2 +ᴿ b2
    , I-is-ideal .close-+ a1∈I b1∈I
    , J-is-ideal .close-+ a2∈J b2∈J
    , res
    where
    ...
    res = i1 +ᴿ i2                 ＝⟨ ap (_+ᴿ i2) i=a1+a2 ⟩
          ...
          (a1 +ᴿ b1) +ᴿ (a2 +ᴿ b2) ∎
  main .close-neg {i} (a , b , a∈I , b∈J , i=a+b) = - a , - b , (I-is-ideal .close-neg a∈I , J-is-ideal .close-neg b∈J , res)
    where
    P : ((- a) +ᴿ (- b)) +ᴿ (a +ᴿ b) ＝ 0r
    ...
    res =
      ...
      (- a) +ᴿ (- b) ∎
  main .closeL r {i} (a , b , a∈I , b∈J , i=a+b) =
    r · a , r · b , I-is-ideal .closeL r a∈I , J-is-ideal .closeL r b∈J
    , res
    where
    res : r · i ＝ r · a +ᴿ r · b
    res = r · i        ＝⟨ ap (r ·_) i=a+b ⟩
          r · (a +ᴿ b) ＝⟨ distribR ⟩
          r · a +ᴿ r · b ∎
  main .closeR r {i} (a , b , a∈I , b∈J , i=a+b) =
    a · r , b · r , I-is-ideal .closeR r a∈I , J-is-ideal .closeR r b∈J
    , res
    where
    res : i · r ＝ a · r +ᴿ b · r
